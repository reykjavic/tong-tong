...
## ⚙️ CI maintenance
- [x] **Bump GitHub Actions off Node 20** (deprecation): `actions/checkout@v4`, `actions/setup-node@v4`, `actions/upload-artifact@v4` are being force-run on Node 24 — pin newer major versions (first seen in deploy run `32051443916`, 2026-08-17) — done 2026-08-19: `node-version: 24`, all actions `@v5`
